      ...
      <div className="container px-4 mx-auto max-w-4xl">
        ...
        <GlassPanel className="mb-10 animate-fade-in">
          ...
          <div className="space-y-6">
            <div>
              <h2 className="text-lg font-medium mb-3">Definition{word.definitions.length > 1 ? 's' : ''}</h2>
        ...
        <div className="space-y-6 animate-fade-in">
          ...
          <div className="space-y-4">
            {word.examples.map((example, index) => (
              <GlassPanel key={index} className={cn(
                "border-l-4 transition-all",
                index % 2 === 0 ? "border-l-primary/70" : "border-l-blue-400/70"
              )}>
